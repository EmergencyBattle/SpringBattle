...
var about = document.getElementById("aboutwrapper");
...
function menuclick() {
    ...
    if (hasrun == true) {
        ...
        setTimeout(function(){aboutContentZIndexHigher();},1000);
    } else {
        aboutContentZIndexLower();
        menuMove();
        backgroundMove();
        fadeMove();
        hasrun = true;
...
function aboutContentZIndexHigher() {
    about.style.zIndex = "26";
    console.log("higher");
}

function aboutContentZIndexLower() {
        about.style.zIndex = "12";
        console.log("lower");
}
